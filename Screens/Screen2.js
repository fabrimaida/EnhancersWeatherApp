...
export default function Screen2(props) {
  ...
  const [weatherNowImg,setWeatherNowImg] = useState(require('../assets/sun.png'))
  ...
  // useEffect({} => {
    ...
    fetch('https://api.openweathermap.org/data/2.5/onecall?lat=45.070339&lon=7.686864&appid=25068c72bbe11cb7c9b0600f15ebbd06')
    ...
    <View style={styles.container} >
      <ImageBackground source={require('../assets/cover.jpg')} style={styles.image}>
        ...
        <View style={styles.upperView}>
          ...
          <Text style={styles.title1} > Turin </Text>
          <TouchableOpacity>
