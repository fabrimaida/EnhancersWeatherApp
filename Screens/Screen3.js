...
export default function Screen3(props) {
  ...
  // useEffect({} => {
    ...
    fetch('https://api.openweathermap.org/data/2.5/onecall?lat=51.507351&lon=-0.127758&appid=25068c72bbe11cb7c9b0600f15ebbd06')
    ...
    <View style={styles.container} >
      <ImageBackground source={require('../assets/cover.jpg')} style={styles.image}>
        ...
        <View style={styles.upperView}>
          ...
          <Text style={styles.title1} >London</Text>
          <TouchableOpacity>
